...
export default function Hero({ title = "Briggs' Book Club", subtitle = "Read. Reflect. Remember.", description, backgroundImage = "/WhatsApp Image 2025-11-03 at 3.08.19 PM.jpeg" }: HeroProps) {
  return (
